function [p, fwhmConfX, fwhmConfY, success, control] = ...
  calibrateInvoker(p, FWHMmin, FWHMmax, fwhmConfX, fwhmConfY, lens_shift, voxelSize, doOnlineCalibration, computeZPosition)
  ...
  [p, fwhmConfX, fwhmConfY, ~, ~, success, control] = mda2([], voxelSize, ...
                                                         trackingParams, 0, 64, ...
                                                         p, ...
                                                         fwhmConfX, fwhmConfY, ...
                                                         [-500 - lens_shift, 500] ...
                                                         ./ voxelSize(3) ,1, doOnlineCalibration, ...
                                                         0, 1,computeZPosition);
