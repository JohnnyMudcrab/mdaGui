...
% Jean-Yves Tinevez < jeanyves.tinevez@gmail.com> November 2011 - 2012
        ...
        switch lower(method)
            ...
            case 'hungarian'
                [target_indices , ~, unmatched_targets{i+1} ] = ...
                    bin.hungarianlinker(source, target, max_linking_distance);
        
            case 'nearestneighbor'
                [target_indices , ~, unmatched_targets{i+1} ] = ...
                    bin.nearestneighborlinker(source, target, max_linking_distance);
    ...
    for i = 1 : n_slices-2
        ...
        for j = i + 2 : min(i +  max_gap_closing, n_slices)
            ...
            target_indices = bin.nearestneighborlinker(source, target, max_linking_distance);
